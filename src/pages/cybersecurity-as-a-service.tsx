  ...
  return (
    <>
      <Seo
        ...
        image="/og-images/cybeersecurity-meta-img.png"
              ...
              <div className={styles.text_holder}>
                <Fade direction="down">
                  <p className={styles.details}>
                    In recent years, cyber threats to businesses have surged,
                    with a staggering 85.7% of Canadian companies experiencing
                    at least one cyberattack in 2021.
                    <br /> <br />
                    ...
                    <br /> <br />
                    We also provide IT Compliance and Security Awareness
                    Training, ensuring your business stays protected and
                    compliant while keeping your data secure. Partner with us
                    for peace of mind in an increasingly digital world.
                  </p>
                </Fade>
              </div>
            </div>
          ...
          <div className={styles.text_holder}>
            ...
            <Fade direction="down">
              <p className={styles.details}>
                ...
                organization&apos;s digital future with our trusted
                  ...
                  <ul className={styles.list_group}>
                    ...
                    <li>
                      ...
                      <div>
                        ...
                        help you navigate complex regulatory landscapes and
                        ensure that your IT practices align with compliance
                        requirements.
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <div>
                        ...
                        you in creating robust business continuity plans to
                        ensure that your operations can continue even in the
                        face of disruptions.
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <div>
                        ...
                        training programs empower your workforce to recognize
                    ...
                    <li>
                      ...
                      />
                      <div>
                        <strong>Data Protection and Privacy:</strong> We
                        implement robust data protection measures and ensure
              ...
              <div className={`${styles.text_holder}`}>
                ...
                <Fade direction="down">
                  <p className={styles.details}>
                    ...
                    fortify your business against relentless threats, and
                    Turnkey Kinetics is your strategic ally in the
                    ever-escalating battle against cyber adversaries. Our
                    Managed Security Solutions are crafted to keep pace with the
                    ever-changing cybersecurity landscape, ensuring that your
          ...
          <section className="row" id="malware_protection">
            <div className="col-12 mb-3">
              <div className={`${styles.text_holder}`}>
                ...
                <Fade direction="down">
                  <p className={styles.details}>
                    At Turnkey Kinetics we transformed safeguarding digital
                    assets into an art form; with comprehensive Phishing and
                    Malware Protection services that are meticulously designed
                    to counteract evolving cyber threats, making us your trusted
                    ...
                    Malware Protection. But what does this protection entail,
                    and how does Turnkey Kinetics lead the charge in securing
                  ...
                  <ul className={styles.list_group}>
                    ...
                    <li>
                      ...
                      <div>
                        ...
                        identification and response to emerging security
                        threats.
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <div>
                        ...
                        Identify anomalies in behavior for early threat
                        detection.
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      />
                      <div>
                        <strong> Employee Training:</strong> Educate personnel
                        for enhanced awareness and proactive cybersecurity
                        measures.
                      </div>
                    </li>
                  </ul>
          ...
          <section className="row" id="penetration_testing">
            <div className="col-12 mb-3">
              <div className={`${styles.text_holder}`}>
                ...
                <Fade direction="down">
                  <p className={styles.details}>
                    At Turnkey Kinetics, our Vulnerability and Penetration
                    Testing (VAPT) services are designed to help you not only
                    combat threats but also chart a course for a secure digital
                    future. There are always risks online, but with our
                    services, you will always be ahead of the game.
                    <br />
                    ...
                    and empower your organization in a digital world fraught
                    with threats.
                  </p>
                </Fade>
              </div>
                ...
                <Fade direction="down">
                  <ul className={styles.list_group}>
                    ...
                    <li>
                      ...
                      <div>
                        <strong> Vulnerability Assessment:</strong> Identify and
                        evaluate weaknesses in software and network
                        infrastructure for proactive security.
                      </div>
                    </li>
                    <li>
                      <Image
                    ...
                    <li>
                      ...
                      />
                      <div>
                        <strong>Dynamic and Static Code Analysis:</strong>{" "}
                        Examine software code in motion and at rest for security
                    ...
                    <li>
                      ...
                      />
                      <div>
                        <strong>Compliance Safeguarding:</strong> Ensure
                        adherence to regulatory standards and industry
                        compliance, minimizing legal and financial risks.
                      </div>
                    </li>
                    <li>
                      <Image
          ...
          <section className="row" id="awareness_training">
            <div className="col-12 mb-3">
              <div className={`${styles.text_holder}`}>
                ...
                <Fade direction="down">
                  <p className={styles.details}>
                    At Turnkey Kinetics, we help in equipping your employees
                    with the right knowledge and skills through awareness
                    training. It serves as the firewall against the loss of
                    sensitive data, intellectual property, and financial assets,
                    and safeguarding your brand reputation. This training from
                    our experts directly addresses the common mistakes employees
                    may make in their daily digital interactions, making it a
                    cornerstone of your cybersecurity strategy.
                  </p>
                </Fade>
              </div>
            </div>
                  ...
                  <ul className={styles.list_group}>
                    ...
                    <li>
                      ...
                      <div>
                        ...
                        comprises 3 to 5 modules that are not just informative
                        but engaging, delivered regularly to make cybersecurity
